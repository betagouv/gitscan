...
### Résumé
Ce mois-ci, les améliorations se concentrent sur l'ajout du support des groupes supplémentaires pour le serveur RPC, permettant une gestion plus fine des autorisations. Un correctif a également été apporté pour rendre les tests de multiplexage H2 plus fiables.
...
- Correction d'un problème de non-déterminisme dans les tests de multiplexage H2 en utilisant un client Rust minimal. (d04beda)
